...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Edux features */
        {"edux", "masternode", &masternode, true, true, false},
        {"edux", "listmasternodes", &listmasternodes, true, true, false},
        {"edux", "getmasternodecount", &getmasternodecount, true, true, false},
        {"edux", "masternodeconnect", &masternodeconnect, true, true, false},
        {"edux", "masternodecurrent", &masternodecurrent, true, true, false},
        {"edux", "masternodedebug", &masternodedebug, true, true, false},
        {"edux", "startmasternode", &startmasternode, true, true, false},
        {"edux", "createmasternodekey", &createmasternodekey, true, true, false},
        {"edux", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"edux", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"edux", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"edux", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"edux", "getmasternodescores", &getmasternodescores, true, true, false},
        {"edux", "mnbudget", &mnbudget, true, true, false},
        {"edux", "preparebudget", &preparebudget, true, true, false},
        {"edux", "submitbudget", &submitbudget, true, true, false},
        {"edux", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"edux", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"edux", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"edux", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"edux", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"edux", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"edux", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"edux", "checkbudgets", &checkbudgets, true, true, false},
        {"edux", "mnsync", &mnsync, true, true, false},
        {"edux", "spork", &spork, true, true, false},
        {"edux", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"edux", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use eduxd, or the -server option to edux-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> edux-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:31513/\n";
}
