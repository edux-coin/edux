                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Edux from zEdux"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zEdux"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zEdux));
