                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("EDUX Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a EDUX address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and edux: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zEDUX"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About EDUX Core"), this);
    aboutAction->setStatusTip(tr("Show information about EDUX Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for EDUX"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your EDUX addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified EDUX addresses"));
    ...
    openAction->setStatusTip(tr("Open a EDUX: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the EDUX Core help message to get a list with possible EDUX command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("EDUX Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to EDUX network", "", count));
}
...
{
    QString strTitle = tr("EDUX Core"); // default title
