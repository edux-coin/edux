...
#   c) node1 mines 32 blocks, so now node 0 has 60001edux, node 1 has 4250edux, node2 has none.
#   d) node0 sends 601 edux to node2, in two transactions (301 edux, then 300 edux).
