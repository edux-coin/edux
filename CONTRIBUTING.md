Contributing to EDUX Core
============================

The EDUX Core project operates an open contributor model where anyone is
...
The following applies to code changes to the EDUX Core project, and is not to be
confused with overall EDUX Network Protocol consensus changes.

Whether a pull request is merged into EDUX Core rests with the project merge
...
Patches that change EDUX consensus rules are considerably more involved than
...
Where a patch set proposes to change the EDUX consensus, it must have been
...
The project leader is the release manager for each EDUX Core release.
