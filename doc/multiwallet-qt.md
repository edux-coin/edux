...
In order to support loading of multiple wallets in edux-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is edux.cpp.
...
Changes to edux.cpp
----------------------
edux.cpp is the entry point into edux-qt, and as such, will require some minor modifications to provide hooks for
