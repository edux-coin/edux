...
This mechanism has been integrated into Bitcore-Node-EDUX which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/EDUX-Project/insight-api-edux#web-socket-api](https://github.com/EDUX-Project/insight-api-edux#web-socket-api) 
* API: [https://github.com/EDUX-Project/insight-api-edux#swifttx-transactions](https://github.com/EDUX-Project/insight-api-edux#swifttx-transactions) 
...
By default, the EDUX Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the EDUX Core daemon:
