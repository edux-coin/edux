...
RESOURCES += src/qt/edux.qrc src/qt/edux_locale.qrc

TRANSLATIONS += src/qt/locale/edux_bg.ts \
                src/qt/locale/edux_de.ts \
                src/qt/locale/edux_en.ts \
                src/qt/locale/edux_es.ts \
                src/qt/locale/edux_fi.ts \
                src/qt/locale/edux_fr.ts \
                src/qt/locale/edux_it.ts \
                src/qt/locale/edux_ja.ts \
                src/qt/locale/edux_pl.ts \
                src/qt/locale/edux_pt.ts \
                src/qt/locale/edux_ru.ts \
                src/qt/locale/edux_sk.ts \
                src/qt/locale/edux_sv.ts \
                src/qt/locale/edux_vi.ts \
                src/qt/locale/edux_zh_CN.ts \
                src/qt/locale/edux_zh_TW.ts
